...
3. The customer completes the payment using the selected payment method.
4. HelloPay updates the payin status asynchronously and sends webhook events.
5. After the flow ends, the user is redirected to the `callbackUrl` you provided.
